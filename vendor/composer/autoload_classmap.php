...
return array(
    ...
    'Phlex\\Server\\Core\\Application' => $baseDir . '/src/Server/Core/Application.php',
    'Phlex\\Server\\Http\\Response' => $baseDir . '/src/Server/Http/Response.php',
    'Phlex\\Tests\\Unit\\Server\\Core\\ApplicationTest' => $baseDir . '/tests/Unit/Server/Core/ApplicationTest.php',
    ...
    'Webman\\Finder\\ControllerFinder' => $vendorDir . '/workerman/webman-framework/src/Finder/ControllerFinder.php',
    'Webman\\Finder\\FileInfo' => $vendorDir . '/workerman/webman-framework/src/Finder/FileInfo.php',
    'Webman\\Finder\\Finder' => $vendorDir . '/workerman/webman-framework/src/Finder/Finder.php',
    ...
    'Workerman\\Redis\\Client' => $vendorDir . '/workerman/redis/src/Client.php',
    'Workerman\\Redis\\Exception' => $vendorDir . '/workerman/redis/src/Exception.php',
    'Workerman\\Redis\\Protocols\\Redis' => $vendorDir . '/workerman/redis/src/Protocols/Redis.php',
    ...
    'support\\Request' => $vendorDir . '/workerman/webman-framework/src/support/Request.php',
    ...
    'support\\annotation\\route\\Any' => $vendorDir . '/workerman/webman-framework/src/support/annotation/route/Any.php',
    'support\\annotation\\route\\Delete' => $vendorDir . '/workerman/webman-framework/src/support/annotation/route/Delete.php',
    'support\\annotation\\route\\DisableDefaultRoute' => $vendorDir . '/workerman/webman-framework/src/support/annotation/route/DisableDefaultRoute.php',
    'support\\annotation\\route\\Get' => $vendorDir . '/workerman/webman-framework/src/support/annotation/route/Get.php',
    'support\\annotation\\route\\Head' => $vendorDir . '/workerman/webman-framework/src/support/annotation/route/Head.php',
    'support\\annotation\\route\\Options' => $vendorDir . '/workerman/webman-framework/src/support/annotation/route/Options.php',
    'support\\annotation\\route\\Patch' => $vendorDir . '/workerman/webman-framework/src/support/annotation/route/Patch.php',
    'support\\annotation\\route\\Post' => $vendorDir . '/workerman/webman-framework/src/support/annotation/route/Post.php',
    'support\\annotation\\route\\Put' => $vendorDir . '/workerman/webman-framework/src/support/annotation/route/Put.php',
    'support\\annotation\\route\\Route' => $vendorDir . '/workerman/webman-framework/src/support/annotation/route/Route.php',
    'support\\annotation\\route\\RouteGroup' => $vendorDir . '/workerman/webman-framework/src/support/annotation/route/RouteGroup.php',
